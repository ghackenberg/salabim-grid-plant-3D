...
processSteps1 = Operation('Process step 1', 1, 5, 0.15, machineType1, toolType1, productType1, productType2)
processSteps2 = Operation('Process step 2', 1, 4, 0.20, machineType1, toolType2, productType1, productType3)
