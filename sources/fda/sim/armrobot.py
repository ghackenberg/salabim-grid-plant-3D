...
class SimArmRobot(SimRobot):
    def setup(self, corridor: Corridor, machines: list[Machine], direction: str, store_in: sim.Store, store_out_arm: sim.Store, store_out_main: sim.Store, sim_machines: list[SimMachine], dx: float, y: float):
        super().setup(f"Arm {direction} robot", 2, dx, y, 2.5, "green")
